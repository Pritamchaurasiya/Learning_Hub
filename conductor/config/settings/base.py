...
if not SECRET_KEY and not os.getenv("DEBUG", "False").lower() == "true":
    raise ValueError("The SECRET_KEY environment variable is not set in production.")
if not SECRET_KEY:
...
CELERY_BEAT_SCHEDULE = {
    "reset-weekly-xp": {
        "task": "tasks.tasks.reset_weekly_xp",
        "schedule": 604800,  # Every Monday (7 days)
    },
    "check-streak-expiry": {
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@learninghub.com")
