    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "daily_test_limit",
                    models.IntegerField(default=3, help_text="Tests per day"),
                ),
                (
                    "monthly_ai_generations",
                    models.IntegerField(
                        default=5, help_text="AI-generated tests per month"
                    ),
                ),
                (
                    "max_analytics_depth",
                    models.IntegerField(
                        default=1, help_text="Analytics depth level (1-3)"
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="user_subscr_provide_23c9a9_idx",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="paymenttransaction",
            index=models.Index(
                fields=["status", "created_at"], name="payment_tra_status_ea288f_idx"
            ),
        ),
    ]
