...
class QuizAnswerInline(admin.TabularInline):
    ...
    model = QuizAnswer
    extra = 0
    readonly_fields = ['question', 'selected_option', 'text_answer', 'is_correct', 'marks_obtained']


@admin.register(Quiz)
class QuizAdmin(admin.ModelAdmin):
    """Admin for Quiz model."""
    list_display = ['title', 'course', 'time_limit_minutes', 'passing_score', 'is_published', 'created_at']
...
class QuizAttemptAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'quiz', 'status', 'score', 'percentage_score', 'attempt_number', 'started_at']
...
class QuizAnswerAdmin(admin.ModelAdmin):
    ...
    list_filter = ['is_correct']
    readonly_fields = ['attempt', 'question', 'selected_option', 'text_answer', 'is_correct', 'marks_obtained']
