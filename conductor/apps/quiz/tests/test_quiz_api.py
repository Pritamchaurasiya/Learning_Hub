...
from apps.quiz.models import Quiz, Question, Option, QuizAttempt, QuizAnswer
...
class QuizAPITests(APITestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(name='Test Category', slug='test-cat-api')
        self.course = Course.objects.create(
            title='Test Course',
            slug='test-course',
            description='Test description',
    ...
    def test_get_quizzes_by_course(self):
        ...
        response = self.client.get(f'/api/v1/quizzes/by_course/?course_id={self.course.id}')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertIn('data', response.data)
...
class QuizAttemptAPITests(APITestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(name='Test Category', slug='test-cat-attempt')
        self.course = Course.objects.create(
            title='Test Course',
            slug='test-course',
            description='Test description',
