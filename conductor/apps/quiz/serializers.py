...
class QuizListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'total_questions', 'total_marks', 'course_title',
...
class QuizAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuizAttempt
        fields = [
            'id', 'quiz', 'quiz_title', 'course_title', 'status',
            'score', 'max_score', 'percentage_score', 'started_at',
            'completed_at', 'time_taken_seconds', 'attempt_number',
            'is_passed'
        ]
