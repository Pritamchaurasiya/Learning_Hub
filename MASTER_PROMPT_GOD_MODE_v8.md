# 🚀 MASTER_PROMPT - GOD MODE v8.0 - OMNISCIENT PRODUCTION ENGINE
...
4. Teach concept before implementation
...
3. Include C++, Python, Dart, Security, Architecture
...
### Priority 1: Linux CMakeLists.txt (BLOCKING)
...
# Line 3
- isproject(runner LANGUAGES CXX)
...
│   ├── lib/src/
│   │   ├── core/             # API, themes, utils
│   │   └── features/         # Feature modules
│   ├── windows/runner/       # Windows C++ runner
│   └── linux/runner/         # Linux C++ runner
│
...
_God Mode v8.0 - Omniscient Production Engine - Learning Hub_
