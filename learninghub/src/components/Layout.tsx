...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-mesh relative selection:bg-primary-500/30 selection:text-primary-900 dark:selection:text-primary-100">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-purple-500/10 rounded-full blur-[120px] animate-pulse-subtle" style={{ animationDelay: '2s' }} />
      </div>
