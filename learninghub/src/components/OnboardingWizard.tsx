  ...
  const steps: OnboardingStep[] = [
    {
      ...
      description:
        'Your personalized engineering path is ready. Master software mastery with 70+ enterprise-grade courses across 4 strategic phases.',
      icon: Sparkles,
    ...
    },
    {
      ...
      description:
        'Navigate through Beginner, Intermediate, and Advanced phases. Each lesson is optimized for maximum cognitive retention.',
      icon: Layers,
    ...
    },
    {
      ...
      description:
        'Solve real-world challenges in our Practice Arena. Track your mastery distribution and climb the global engineering ranks.',
      icon: Code2,
    ...
    },
    {
      ...
      description:
        'Monitor your logical streak, earn XP, and unlock neural achievements. Your growth is visualized with deep-dive analytics.',
      icon: Target,
            ...
            <div className="p-8 md:p-12 relative z-10">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <p
                      className={`text-[10px] font-black uppercase tracking-[0.3em] ${step.color}`}
                    >
                      {step.subtitle}
                    </p>
