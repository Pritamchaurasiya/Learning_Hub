        ...
        <div className="lg:col-span-2 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-bold uppercase">
                      {dbStatus?.database ?? 'PostgreSQL/SQLite'}
                    </p>
                  </div>
                </div>
                <div
                  ...
                  style={{
                    backgroundColor: `${getHealthColor(dbStatus?.status)}20`,
                    color: getHealthColor(dbStatus?.status),
                  }}
                >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-xl font-black tabular-nums">
                    {dbStatus?.response_time_ms.toFixed(1)}ms
                  </span>
                </div>
            ...
            <Card className="p-6 border-none shadow-xl bg-white dark:bg-gray-900/50">
              <div className="flex items-start justify-between mb-6">
                ...
                <div
                  className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest"
                  style={{
                    backgroundColor: `${getHealthColor(cacheStatus?.status)}20`,
                    color: getHealthColor(cacheStatus?.status),
                  }}
                >
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  ...
                  <span className="text-xl font-black tabular-nums">
                    {cacheStatus?.response_time_ms.toFixed(1)}ms
                  </span>
                </div>
                <div className="h-1.5 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    initial={{ width: 0 }}
                    animate={{
                      width: `${Math.min(100, (cacheStatus?.response_time_ms ?? 0) * 5)}%`,
                    }}
                  />
                </div>
                <div className="pt-2 flex items-center justify-between text-[10px] font-bold text-gray-400 uppercase tracking-tighter">
                  ...
                  <span className="flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3 text-emerald-500" /> High Availability
                  </span>
                </div>
              </div>
            </Card>
          ...
          <Card className="overflow-hidden border-none shadow-xl">
            <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-white dark:bg-gray-900/50">
              ...
              <span className="px-2 py-0.5 rounded-md bg-gray-100 dark:bg-gray-800 text-[10px] font-black text-gray-500 uppercase">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                  {processes.map(proc => (
                    ...
                    >
                      <td className="px-6 py-4 text-xs font-bold tabular-nums text-gray-400">
                        #{proc.pid}
                      </td>
                      <td className="px-6 py-4 text-xs font-black text-gray-700 dark:text-gray-200 uppercase tracking-tight">
                        {proc.name}
                      </td>
                      <td className="px-6 py-4 text-xs font-black text-right tabular-nums text-primary-500">
                        {proc.cpu_percent.toFixed(1)}%
                      </td>
                      <td className="px-6 py-4 text-xs font-black text-right tabular-nums text-purple-500">
        ...
        <div className="space-y-6">
          ...
          {metrics?.application && (
            <Card className="p-6 border-none shadow-xl bg-gradient-to-br from-primary-600 to-indigo-700 text-white">
              <h3 className="font-black text-xs uppercase tracking-[0.2em] mb-6 opacity-80">
                Platform Statistics
              </h3>
              <div className="space-y-6">
          ...
          <Card className="p-6 border-none shadow-xl">
            <h3 className="font-black text-[10px] uppercase tracking-[0.2em] text-gray-400 mb-6">
              AI Core Diagnostics
            </h3>
            ...
            <Button
              variant="outline"
              fullWidth
              className="mt-6 rounded-xl text-[10px] font-black uppercase tracking-widest py-4 border-2"
            >
