...
describe('ErrorHandler Middleware', () => {
    ...
    describe('errorHandler', () => {
        it('should handle operational errors with custom status code', () => {
            const error = new errorHandler_1.AppError('Validation failed', 400, undefined, true);
        ...
        it('should handle 404 not found errors', () => {
            const error = new errorHandler_1.AppError('Resource not found', 404, undefined, true);
        ...
        it('should handle 500 server errors with generic message', () => {
            const error = new errorHandler_1.AppError('Database connection failed', 500, undefined, false);
        ...
        it('should include stack trace in development mode', () => {
            ...
            const error = new errorHandler_1.AppError('Test error', 500, undefined, false);
            mockReq.originalUrl = '/api/test';
            mockReq.method = 'GET';
            (0, errorHandler_1.errorHandler)(error, mockReq, mockRes, mockNext);
