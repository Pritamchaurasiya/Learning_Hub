...
describe('AdminController', () => {
    ...
    describe('getDashboardStats', () => {
        it('should return dashboard stats successfully', async () => {
            ...
            await (0, adminController_1.getDashboardStats)(mockReq, mockRes, jest.fn());
    ...
    describe('getUsers', () => {
        it('should return paginated users', async () => {
            ...
            await (0, adminController_1.getUsers)(mockReq, mockRes, jest.fn());
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
                status: 'success',
                data: {
    ...
    describe('updateUserRole', () => {
        it('should update user role successfully', async () => {
            ...
            await (0, adminController_1.updateUserRole)(mockReq, mockRes, jest.fn());
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
                status: 'success',
    ...
    describe('deleteUser', () => {
        it('should delete user successfully', async () => {
            ...
            await (0, adminController_1.deleteUser)(mockReq, mockRes, jest.fn());
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
                status: 'success',
    ...
    describe('getSystemStatus', () => {
        it('should return system status when database is connected', async () => {
            ...
            await (0, adminController_1.getSystemStatus)(mockReq, mockRes, jest.fn());
            expect(statusMock).toHaveBeenCalledWith(200);
            expect(jsonMock).toHaveBeenCalledWith({
                status: 'success',
                data: {
