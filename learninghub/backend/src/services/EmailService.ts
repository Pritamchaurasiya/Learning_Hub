...
export class EmailService {
  ...
  private initialize(): void {
    ...
    try {
      ...
      logger.error(
        '[EmailService] Failed to configure SMTP',
  ...
  private templates = {
    verification: (name: string, url: string): string => `
      <!DOCTYPE html>
      <html>
    ...
    passwordReset: (name: string, url: string): string => `
      <!DOCTYPE html>
      <html>
    ...
    contestNotification: (name: string, title: string, startTime: Date, url: string): string => `
      <!DOCTYPE html>
      <html>
    ...
    subscriptionConfirmation: (name: string, tier: string, amount: string): string => `
      <!DOCTYPE html>
      <html>
