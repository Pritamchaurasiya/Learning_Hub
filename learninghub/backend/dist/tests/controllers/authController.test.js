...
describe('AuthController', () => {
    ...
    describe('register', () => {
        it('should register a new user successfully', async () => {
            ...
            prismaClient_1.prisma.user.create.mockResolvedValue(createdUser);
        ...
        it('should return 409 when email already exists', async () => {
            ...
            const existingUser = (0, user_factory_1.createUser)({ email: userData.email });
            mockReq.body = userData;
            prismaClient_1.prisma.user.findUnique.mockResolvedValue(existingUser);
            await (0, authController_1.register)(mockReq, mockRes);
    ...
    describe('refresh', () => {
        ...
        it('should refresh token successfully', async () => {
            ...
            await (0, authController_1.refresh)(mockReq, mockRes);
            expect(jsonMock).toHaveBeenCalledWith({
                status: 'success',
                data: {
                    access_token: 'mock-token',
