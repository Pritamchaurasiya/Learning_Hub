...
async function main() {
  ...
  await prisma.pYQ
    .upsert({
      ...
      create: {
        ...
        answer:
          '$2x = 30^\\circ, 150^\\circ, 390^\\circ, 510^\\circ \\implies x = 15^\\circ, 75^\\circ$',
  ...
  const jeePhysicsQuestions = [
    ...
    },
    {
      ...
      explanation:
        'Time t1 for 1/3 decay means 2/3 remains. Time t2 for 2/3 decay means 1/3 remains. The remaining amount goes from 2/3 to 1/3, which is exactly half of what was present at t1. Thus, t2 - t1 is one half-life, which is 20 minutes.',
      difficulty: 'MEDIUM',
  ...
  const neetBioQuestions = [
    ...
    },
    {
      ...
      explanation:
        'The term linkage was coined by T.H. Morgan to describe the physical association of genes on a chromosome.',
      difficulty: 'EASY',
    ...
    },
    {
      id: 'mock-neet-3',
      question:
        'In a standard ECG, which of the following alphabets is the correct representation of the respective activity of the human heart?',
      options: [
        'S - start of systole',
        'T - end of diastole',
      ...
      explanation:
        'In a standard ECG, the P wave represents the electrical excitation (or depolarisation) of the atria.',
      difficulty: 'MEDIUM',
